...
actions.start = function()
	os.execute("/usr/bin/urserver-eden-helper start");
end

actions.close = function()
	os.execute("/usr/bin/urserver-eden-helper close");
end
...
actions.tv = function()
	os.execute("/usr/bin/urserver-eden-helper tv");
end

actions.speakers = function()
	os.execute("/usr/bin/urserver-eden-helper speakers");
end
